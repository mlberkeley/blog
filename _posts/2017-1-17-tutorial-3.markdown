...
<div id="alt-interactive">
  <div class="mySlides">
    <img id="alt-visual" src="{{ site.baseurl }}/assets/tutorials/3/alt-visualization/slides/slide-0.png" style="width:100%">
  </div>
...
if((isChrome || isSafari) && !isMobile) { 
  ...
  if(isIE) {
    document.getElementById("alt-interactive").src = '{{ site.baseurl }}/assets/tutorials/3/visualization.gif';
  }
