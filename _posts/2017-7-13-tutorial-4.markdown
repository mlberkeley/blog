...
<center>
  ...
  <div style="max-width: 70%;">
  <p style="font-size: 16px;">
    Cross validation with k=3. We divide the entire test set into three parts, and then train our model three times using each part as the validation set with the remaining two parts making up our training set.
  </p>
  </div>
</center>
