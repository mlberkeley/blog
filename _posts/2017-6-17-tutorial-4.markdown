...
<div style="margin-left: 100px; margin-right: 100px">
<p style="font-size: 16px;">
Details: We are training a locally-weighted linear regression model (LOWESS) on a sine wave with added gaussian noise. (Thank you to <a src="https://gist.github.com/agramfort/850437">agramfort</a> for the LWLR code). The smoothing parameter is used as a proxy for complexity, and the error is the average L1 distance.
</p>
</div>
