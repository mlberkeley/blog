...
We're almost there! Because both $$ f $$ is fully deterministic, by linearity of expectation:
...
But $$ \operatorname{Var}[\epsilon] = \sigma^2 $$! Substituting we obtain our decomposition:
